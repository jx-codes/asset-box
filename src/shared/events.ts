...
import { AssetIdSchema, AssetSchema } from "./domain"
...
export const AssetEventSchema = z.discriminatedUnion("tag", [
  ...
  z.object({ tag: z.literal("asset-deleted"), assetId: AssetIdSchema }),
  z.object({ tag: z.literal("tags-changed") }),
  z.object({ tag: z.literal("work-request-changed"), requestId: WorkRequestIdSchema }),
  z.object({ tag: z.literal("public-shares-changed"), assetId: AssetIdSchema }),
  z.object({
